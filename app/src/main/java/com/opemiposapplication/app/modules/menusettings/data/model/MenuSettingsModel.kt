package com.opemiposapplication.app.modules.menusettings.`data`.model
...
data class MenuSettingsModel(
   ...
   */
  var txtOWNYOURWEIRD: String? = MyApp.getInstance().resources.getString(R.string.lbl_settings)
  ,
  /**
   * TODO Replace with dynamic value
   */
