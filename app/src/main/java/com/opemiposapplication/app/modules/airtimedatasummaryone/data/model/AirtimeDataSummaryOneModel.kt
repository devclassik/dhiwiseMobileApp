package com.opemiposapplication.app.modules.airtimedatasummaryone.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AirtimeDataSummaryOneModel(
  /**
  ...
  var txtEnterReceipien: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_data_package)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtFilesize: String? = MyApp.getInstance().resources.getString(R.string.msg_mtn_monthly_12g)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtEnterReceipienOne: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_data_amount)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtNCounter: String? = MyApp.getInstance().resources.getString(R.string.lbl_n_3_000_00)
  ,
  /**
   * TODO Replace with dynamic value
   */
