package com.opemiposapplication.app.modules.billpaymentbeneficiaryone.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class BillPaymentBeneficiaryOneModel(
  /**
  ...
  var txtEnterReceipien: String? =
      MyApp.getInstance().resources.getString(R.string.msg_enter_smartcard)
  ,
  /**
   * TODO Replace with dynamic value
   */
