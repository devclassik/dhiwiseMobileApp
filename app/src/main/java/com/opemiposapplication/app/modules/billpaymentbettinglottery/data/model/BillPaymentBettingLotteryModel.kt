package com.opemiposapplication.app.modules.billpaymentbettinglottery.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class BillPaymentBettingLotteryModel(
  /**
  ...
  var txtEnteranAccoun: String? =
      MyApp.getInstance().resources.getString(R.string.msg_betting_lotte)
  ,
  /**
   * TODO Replace with dynamic value
   */
