package com.opemiposapplication.app.modules.supportdispute.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class SupportDisputeModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtEnteranAccoun: String? = MyApp.getInstance().resources.getString(R.string.lbl_dispute)
  ,
  /**
   * TODO Replace with dynamic value
   */
