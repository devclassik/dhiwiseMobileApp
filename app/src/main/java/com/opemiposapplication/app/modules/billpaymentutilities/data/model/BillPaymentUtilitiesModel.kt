package com.opemiposapplication.app.modules.billpaymentutilities.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class BillPaymentUtilitiesModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtEnteranAccoun: String? = MyApp.getInstance().resources.getString(R.string.lbl_utilities)
  ,
  /**
   * TODO Replace with dynamic value
   */
