package com.opemiposapplication.app.modules.billpaymentbeneficiary.`data`.model

import com.opemiposapplication.app.R
import com.opemiposapplication.app.appcomponents.di.MyApp
import kotlin.String

data class BillPaymentBeneficiaryModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_enter_betting)
  ,
  /**
   * TODO Replace with dynamic value
   */
  ...
  var txtEnterReceipien: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_enter_username)
  ,
  /**
   * TODO Replace with dynamic value
   */
